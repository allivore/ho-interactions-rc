...
optcfg = {
    "exp": "fhn_d005-o3n-monte_carlo_rossler300n_dt0.02-9/",
}


if __name__ == "__main__":
    global_params.training_data_path = \
        global_params.project_path + "/Data/rcc_train_rossler_23.04.24-2-dt0.02-ext2.pickle"
    global_params.testing_data_path = \
        global_params.project_path + "/Data/rcc_test_rossler_23.04.24-2-dt0.02-ext2.pickle"
    args_dict = {
        ...
        "iterative_prediction_length": 25000,
        "num_test_ICS": 1,
        "solver": "auto",
